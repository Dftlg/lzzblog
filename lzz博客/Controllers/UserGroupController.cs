...
namespace lzz博客.Controllers
{
    public class UserGroupController : Controller
    {
        ...
        {
            userGroupRsy = new UserGroupRepository();
            var _userGroup = userGroupRsy.Find(GroupId);
        ...
        {
            userGroupRsy = new UserGroupRepository();
            if (userGroupRsy.Delete(GroupId)) return Json(true);
       ...
       // [AdminAuthorize]
        public ActionResult List(int Id=-1)
        {
            ...
            if (_typeLists.Any(t => t.Value == Id.ToString()))
                _typeLists.SingleOrDefault(t => t.Value == Id.ToString()).Selected = true;
