...
THREE.CanvasRenderer = function (a) {
	...
	this.render = function (a, j) {
		...
		function Q(a, d, f, g, h, k, i, q, o) {
			...
			else if (G = a.positionScreen.x, H = a.positionScreen.y, I = d.positionScreen.x, Y = d.positionScreen.y, L = f.positionScreen.x, B = f.positionScreen.y, S = g.positionScreen.x, v = g.positionScreen.y, R = h.positionScreen.x, P = h.positionScreen.y, V = k.positionScreen.x, J = k.positionScreen.y, q instanceof THREE.MeshBasicMaterial)
...
$(function () {
	...
	particleImage.src = "../../../Content/snow.png";
	var snowNum = 500;
	function init() {
